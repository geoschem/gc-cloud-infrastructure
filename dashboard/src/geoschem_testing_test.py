...
from .models.primary_key_classification import PrimaryKeyClassification
from .models.registry_entry import RegistryEntry
from .models.registry_entry_simulation import RegistryEntrySimulation
from .models.registry_entry_stage import RegistryEntryStage
from .models.registry_entry_diff import RegistryEntryDiff
from .models.new_difference_plot import NewDifferencePlot
...
def test_encoding_decoding_dynamodb_dict():
    ...
    test_dict_encoded = {
        "string1": {"S": "foobar"},
        "map1": {
            "M": {"string2": {"S": "foo"}, "bool1": {"BOOL": False}},
        },
        "list1": {"L": [{"S": "string3"}, {"S": "string4"}]},
    }
...
def test_primary_key_classification():
    assert (
        PrimaryKeyClassification(primary_key="gchp-1Mon-13.4.0-rc.3.bd").classification
        == "GEOS-Chem Simulation"
    )
    assert (
        PrimaryKeyClassification(primary_key="gchp-1Mon-13.4.0-rc.3").classification
        == "GEOS-Chem Simulation"
    )
    assert (
        PrimaryKeyClassification(primary_key="gchp-c24-1Mon-13.4.0-rc.3").classification
        == "GEOS-Chem Simulation"
    )
    assert (
        PrimaryKeyClassification(primary_key="gcc-1Hr-483b659.bd").classification
        == "GEOS-Chem Simulation"
    )
    assert (
        PrimaryKeyClassification(primary_key="gcc-1Hr-483b659").classification
        == "GEOS-Chem Simulation"
    )
    assert (
        PrimaryKeyClassification(primary_key="gcc-4x5-1Hr-483b659").classification
        == "GEOS-Chem Simulation"
    )
    assert (
        PrimaryKeyClassification(
            primary_key="diff-of-diffs-1Mon-gchp-c24-gcc-c24-13.4.0-alpha.26-13.4.0-alpha.27"
        ).classification
        == "Difference Plots"
    )
...
def test_parsing_scan():
    ...
    an_entry_that_should_exist = RegistryEntry(
        primary_key="gcc-1Hr-f9a901a.bd",
        creation_date="2022-03-24",
        execution_status="FAILED",
        execution_site="AWS",
        description="1Hr gcc benchmark simulation using 'f9a901a'",
...
def test_parsing_query():
    ...
    an_entry_that_should_exist = RegistryEntrySimulation(
        primary_key="gchp-1Mon-13.4.0-rc.3.bd",
        creation_date="2022-03-28",
        execution_status="SUCCESSFUL",
        execution_site="AWS",
        description="1Mon gchp benchmark simulation using '13.4.0-rc.3'",
    ...
    an_entry_that_should_exist.setup_run_directory = RegistryEntryStage(
        name="SetupRunDirectory",
        completed=True,
        log_file="http://s3.amazonaws.com/benchmarks-cloud/benchmarks/1Mon/gchp/gchp-1Mon-13.4.0-rc.3.bd/SetupRunDirectory.txt",
        start_time="2022-03-28T17:45:04+0000",
        end_time="2022-03-28T18:00:15+0000",
        metadata="{}",
        artifacts=[
            "s3://benchmarks-cloud/benchmarks/1Mon/gchp/gchp-1Mon-13.4.0-rc.3.bd/SetupRunDirectory_RunDirectory.tar.gz"
        ],
        public_artifacts=[],
    )
    an_entry_that_should_exist.run_simulation_directory = RegistryEntryStage(
        ...
        start_time="2022-03-28T19:26:04+0000",
        end_time="2022-03-29T01:45:15+0000",
        metadata="{}",
        artifacts=[
...
def test_parsing_diff_query():
    ...
    an_entry_that_should_exist = RegistryEntryDiff(
        primary_key="diff-gcc-1Hr-3f70328.bd-gcc-1Hr-3f70328.bd",
        creation_date="2022-04-04",
        execution_status="SUCCESSFUL",
        execution_site="AWS",
        description="1Hr Benchmark plot creation (ref: 'gcc-1Hr-3f70328.bd'; dev:'gcc-1Hr-3f70328.bd')",
    ...
    an_entry_that_should_exist.run_gcpy_stage = RegistryEntryStage(
        name="CreateBenchmarkPlots",
        completed=True,
        log_file="http://s3.amazonaws.com/benchmarks-cloud/diff-plots/1Hr/diff-gcc-1Hr-3f70328.bd-gcc-1Hr-3f70328.bd/CreateBenchmarkPlots.txt",
        start_time="2022-04-04T17:22:44+0000",
        end_time="2022-04-04T17:23:32+0000",
        metadata="{}",
        artifacts=[],
        public_artifacts=[
...
def test_parsing_diff_of_diffs_query():
    ...
    an_entry_that_should_exist.run_gcpy_stage = RegistryEntryStage(
        ...
        start_time="2022-04-13T20:44:26+0000",
        end_time="2022-04-13T20:53:47+0000",
        metadata="{}",
        artifacts=[],
        public_artifacts=[
...
def test_diff_plot_get_put_item():
    ...
    answer = {
        ...
        "S3Uri": {
            "S": "s3://benchmarks-cloud/diff-plots/1Hr/diff-1234-1Hr-1234-abcd-1Hr-abcd"
        },
        "Description": {
            "S": "Benchmark plots for Ref=1234-1Hr-1234 and Dev=abcd-1Hr-abcd (1Hr)"
        },
        "Site": {"S": "AWS"},
        "Stages": {"L": []},
    }
